...
#define ON_Board_LED 2          //--> Definição do pino 2 como "ON_Board_LED", indicação de conexão com o roteador WiFi

const int DHTPin = 5;           //--> O pino utilizado para o sensor DHT22 é o D1 = GPIO5
